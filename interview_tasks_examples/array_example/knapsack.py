# https://www.youtube.com/watch?v=nTABeARo3HU&t=408s
        ...
        for j in range(1, max_weight + 1):  # Итерация по возможным весам
            ...
            if weights[i - 1] <= j:
                ...
                dp[i][j] = max(
                    ...
                    values[i - 1] + dp[i - 1][j - weights[i - 1]]  # Брать предмет, учитывая стоимость текущего
                    # предмета и сколько еще можно засунуть в оставшееся пространство.
                )
            else:
