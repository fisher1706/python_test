...
18. Cтатическое и динамическое тестирование 🔗
...
20. Жизненный цикл разработки ПО 🔗
...
- В Канбані може не бути спринтів. Завдання і пріоритети можна змінювати під час роботи,
  тоді як в Scrum - тільки до по чатку наступного спринта.
